...
export const GET_FAVORITE_INFO_REQUEST = "GET_FAVORITE_INFO_REQUEST";
export const GET_FAVORITE_INFO_SUCCESS = "GET_FAVORITE_INFO_SUCCESS";
export const GET_FAVORITE_INFO_FAILURE = "GET_FAVORITE_INFO_FAILURE";
